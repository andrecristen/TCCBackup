...
import com.example.andrecristen.tccperguntasseparadas.*;
import com.example.andrecristen.tccperguntasseparadas.Geral.TelaFinal;

import java.util.ArrayList;
import java.util.Collections;

public class QuizLogicaCatorzeADezesseis extends AppCompatActivity {

    ArrayList<Integer> numeros = new ArrayList<Integer>();
    private LogicaMatematica14A16 mLivrariaQuestao = new LogicaMatematica14A16();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz_logica_catorze_a_dezesseis);
