package com.example.andrecristen.tccperguntasseparadas.SeisADez.Desafios;
...
public class QuizDesafiosSeisADez extends AppCompatActivity {

    ArrayList<Integer> numeros = new ArrayList<Integer>();
    private DesafiosPegadinhas6A10 mLivrariaQuestao = new DesafiosPegadinhas6A10();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz_desafios_seis_a_dez);
    ...
    private void mudarQuestao() {
        ...
        if (mErros == 5) {
            Intent intent = new Intent(QuizDesafiosSeisADez.this, TelaFinal.class);
            String localizacao = "";
