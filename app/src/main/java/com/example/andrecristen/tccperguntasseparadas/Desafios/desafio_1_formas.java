...
public class desafio_1_formas extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_desafio_1_formas);
    }

    public void startTelaDesafios2(View view) {
        kill_activity();
        Intent telaDesafios2 = new Intent(this, desafio_2_formas.class);
