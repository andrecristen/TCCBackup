...
import com.example.andrecristen.tccperguntasseparadas.OnzeATreze.Logica.LogicaMatematica11A13;
...
public class QuizRaciocinioOnzeATreze extends AppCompatActivity {

    ArrayList<Integer> numeros = new ArrayList<Integer>();
    private RaciocinioLogico11A13 mLivrariaQuestao = new RaciocinioLogico11A13();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz_raciocinio_onze_a_treze);
    ...
    private void mudarQuestao() {
        ...
        if (mErros == 5) {
            Intent intent = new Intent(QuizRaciocinioOnzeATreze.this, TelaFinal.class);
            String localizacao = "";
