...
public class QuizRaciocinioCatorzeADezesseis extends AppCompatActivity {

    ArrayList<Integer> numeros = new ArrayList<Integer>();
    private RaciocinioLogico14A16 mLivrariaQuestao = new RaciocinioLogico14A16();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz_raciocinio_catorze_a_dezesseis);
    ...
    private void mudarQuestao() {
        ...
        if (mErros == 5) {
            Intent intent = new Intent(QuizRaciocinioCatorzeADezesseis.this, TelaFinal.class);
            String localizacao = "";
