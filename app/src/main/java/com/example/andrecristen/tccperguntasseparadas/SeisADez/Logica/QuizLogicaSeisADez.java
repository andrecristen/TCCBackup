...
public class QuizLogicaSeisADez extends AppCompatActivity {
    ArrayList<Integer> numeros = new ArrayList<Integer>();
    private LogicaMatematica6A10 mLivrariaQuestao = new LogicaMatematica6A10();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz_logica_seis_a_dez);
    ...
    private void mudarQuestao() {
        ...
        if (mErros == 5) {
            Intent intent = new Intent(QuizLogicaSeisADez.this, TelaFinal.class);
            String localizacao = "";
