package com.example.andrecristen.tccperguntasseparadas.CatorzeADezesseis.Desafios;
...
public class QuizDesafiosCatorzeADezesseis extends AppCompatActivity {

    ArrayList<Integer> numeros = new ArrayList<Integer>();
    private DesafiosPegadinhas14A16 mLivrariaQuestao = new DesafiosPegadinhas14A16();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz_desafios_catorze_a_dezesseis);
    ...
    private void mudarQuestao() {
        ...
        if (mErros == 5) {
            Intent intent = new Intent(QuizDesafiosCatorzeADezesseis.this, TelaFinal.class);
            String localizacao = "";
