...
import com.example.andrecristen.tccperguntasseparadas.OnzeATreze.Desafios.DesafiosPegadinhas11A13;
...
public class QuizLogicaOnzeATreze extends AppCompatActivity {
    ArrayList<Integer> numeros = new ArrayList<Integer>();
    private LogicaMatematica11A13 mLivrariaQuestao = new LogicaMatematica11A13();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz_logica_onze_a_treze);
    ...
    private void mudarQuestao() {
        ...
        if (mErros == 5) {
            Intent intent = new Intent(QuizLogicaOnzeATreze.this, TelaFinal.class);
            String localizacao = "";
